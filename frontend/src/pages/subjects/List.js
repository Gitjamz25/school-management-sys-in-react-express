...
const SubjectsListPage = (props) => {
	...
	function ActionButton(data){
		...
		{
			label: "View",
			command: (event) => { app.navigate(`/subjects/view/${data.id}`) },
			icon: "pi pi-eye",
			visible: () => auth.canView('subjects/view')
		},
		{
			label: "Edit",
			command: (event) => { app.navigate(`/subjects/edit/${data.id}`) },
			icon: "pi pi-pencil",
	...
	<CanView pagePath="subjects/delete">
		<MultiDelete />
	</CanView>
			</div>
		);
	...
	return (
<main id="SubjectsListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Subjects"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                <div className="col-fixed " >
                    <CanView pagePath="">
                        <Link to={`/subjects/add`}>
                            <Button label="Add New Subject" icon="pi pi-plus" type="button" className="p-button w-full bg-primary "  />
                            </Link>
                        </CanView>
                    </div>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="hod" header="Hod"   ></Column>
...
SubjectsListPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'subjects',
	apiPath: 'subjects/index',
	routeName: 'subjectslist',
