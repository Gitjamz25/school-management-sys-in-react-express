...
const SubjectsEditPage = (props) => {
	...
	if(pageReady){
		return (
<main id="SubjectsEditPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title="Edit Subject"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
SubjectsEditPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'subjects',
	apiPath: 'subjects/edit',
	routeName: 'subjectsedit',
