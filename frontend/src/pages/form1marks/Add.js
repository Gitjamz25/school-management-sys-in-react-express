...
const Form1marksAddPage = (props) => {
	...
	if(pageReady){
		return (
<main id="Form1marksAddPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title="Add New Form 1 Marks"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
Form1marksAddPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'form1marks',
	apiPath: 'form1marks/add',
	routeName: 'form1marksadd',
...
export default Form1marksAddPage;
