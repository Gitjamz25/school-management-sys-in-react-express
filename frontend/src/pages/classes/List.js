...
const ClassesListPage = (props) => {
	...
	function ActionButton(data){
		...
		{
			label: "View",
			command: (event) => { app.navigate(`/classes/view/${data.id}`) },
			icon: "pi pi-eye",
			visible: () => auth.canView('classes/view')
		},
		{
			label: "Edit",
			command: (event) => { app.navigate(`/classes/edit/${data.id}`) },
			icon: "pi pi-pencil",
	...
	<CanView pagePath="classes/delete">
		<MultiDelete />
	</CanView>
			</div>
		);
	...
	return (
<main id="ClassesListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Classes"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                <div className="col-fixed " >
                    <CanView pagePath="">
                        <Link to={`/classes/add`}>
                            <Button label="Add New Class" icon="pi pi-plus" type="button" className="p-button w-full bg-primary "  />
                            </Link>
                        </CanView>
                    </div>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="class_teacher" header="Class Teacher"   ></Column>
...
ClassesListPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'classes',
	apiPath: 'classes/index',
