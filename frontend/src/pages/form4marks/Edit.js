...
const Form4marksEditPage = (props) => {
		const app = useApp();
	...
	const validationSchema = yup.object().shape({
		...
		comp: yup.number().required().label("Comp"),
		total: yup.number().required().label("Total"),
		average: yup.number().required().label("Average")
	});
	// form default values
	...
	if(pageReady){
		return (
<main id="Form4marksEditPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title="Edit Form 4 Marks"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
Form4marksEditPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'form4marks',
	apiPath: 'form4marks/edit',
	routeName: 'form4marksedit',
...
export default Form4marksEditPage;
