...
const Form4marksAddPage = (props) => {
	...
	if(pageReady){
		return (
<main id="Form4marksAddPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title="Add New Form 4 Marks"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
Form4marksAddPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'form4marks',
	apiPath: 'form4marks/add',
	routeName: 'form4marksadd',
...
export default Form4marksAddPage;
