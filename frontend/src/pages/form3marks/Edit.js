...
const Form3marksEditPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
<main id="Form3marksEditPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title="Edit Form 3 Marks"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
Form3marksEditPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'form3marks',
	apiPath: 'form3marks/edit',
	routeName: 'form3marksedit',
...
export default Form3marksEditPage;
