...
const Form2marksAddPage = (props) => {
	...
	if(pageReady){
		return (
<main id="Form2marksAddPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title="Add New Form 2 Marks"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
Form2marksAddPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'form2marks',
	apiPath: 'form2marks/add',
	routeName: 'form2marksadd',
...
export default Form2marksAddPage;
