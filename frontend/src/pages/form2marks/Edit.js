...
const Form2marksEditPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
<main id="Form2marksEditPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container">
            <div className="grid justify-content-between align-items-center">
                ...
                <div className="col " >
                    <Title title="Edit Form 2 Marks"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
            </div>
        </div>
    </section>
...
Form2marksEditPage.defaultProps = {
	primaryKey: 'id',
	pageName: 'form2marks',
	apiPath: 'form2marks/edit',
	routeName: 'form2marksedit',
...
export default Form2marksEditPage;
