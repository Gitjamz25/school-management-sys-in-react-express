                        ...
                        <form onSubmit={formik.handleSubmit}>
                            ...
                            <div className="flex justify-content-between align-items-center my-2">
                                <div className="field-checkbox">
                                    ...
                                    <label className="text-sm text-500" htmlFor="rememberme">Remember Me</label>
                                </div>
                                <div>
                                    <Link to="/forgotpassword" className="p-button p-button-danger p-button-text">Reset Password?</Link>
                                    </div>
                                </div>
                    ...
                    <div className="card  sp-2">
                        <div className="grid gap-3 align-items-center justify-content-between">
                            ...
                            <div className="col-fixed">
                                <Link to="/register">
                                    <Button icon="pi pi-user" label="Register" className="p-button-success" />
                                    </Link>
                                </div>
                            </div>
                        </div>
